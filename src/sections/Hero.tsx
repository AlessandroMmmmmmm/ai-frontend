...
export const Hero = () => {
  ...
  style={{
    ...
    <div className="absolute h-[544px] w-[544px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div className="container relative mt-16">
      ...
      <p className="text-lg text-white/70 mt-5 text-center">
        Elevate your site&apos;s visibilitytools with AI, where smart 
