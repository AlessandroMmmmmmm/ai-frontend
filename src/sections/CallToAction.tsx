...
export const CallToAction = () => {
  ...
  const maskImage = useMotionTemplate`radial-gradient(30% 38% at ${mouseX}px ${mouseY}px, black, transparent)`;
      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative ">
            <h2 className="text-5xl md:text-6xl max-w-sm mx-auto tracking-tigther text-center font-medium">AI-driven SEO for everyone.</h2>
