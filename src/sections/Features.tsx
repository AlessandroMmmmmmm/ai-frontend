...
const FeatureTab = (props: typeof tabs[number] & ComponentPropsWithoutRef<'div'> & {selected: boolean}) => {
  ...
  const maskImg = useMotionTemplate`radial-gradient(80px 80px at ${xPercentage}% ${yPercentage}%, black, transparent)`;
...
export const Features = () => {
  ...
  <section className = "py-20 md:py-24">
    <div className="container">
      ...
      <p className="text-white/70 md:text-xl max-w-2xl mx-auto text-lg tracking-tight text-center mt-5">From small startups to large enterprises, 
